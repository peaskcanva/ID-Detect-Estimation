...
TR_STANDARDS = {
    "50": [
        {
            "variant": "50 kVA (1 Feeder - มาตรฐานเดิม)",
            "TR_CODE": "1050010066",
            "items": {
        ...
        {
            "variant": "50 kVA (2 Feeder - แก้ไขข้อมูลเอง)",
            "TR_CODE": "1050010066",
            "items": {
                "xxxx1": {"name": "รายการใหม่ A", "qty": 0.0},
                "xxxx2": {"name": "รายการใหม่ B", "qty": 0.0},
                "xxxx3": {"name": "รายการใหม่ C", "qty": 0.0},
            }
        }
    ],
    "100": [
